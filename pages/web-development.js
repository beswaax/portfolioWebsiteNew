...
const WebDev = () => {
  ...
  const servicesContent2 = {
    ...
    description2:
      "We have provided professional and dependable website design and web development with measurable results to startups, small businesses, and large corporations. We've helped dozens of businesses in Vancouver and throughout the world acquire a competitive advantage in their sector.",
    description3:
  ...
  const servicesContent3 = {
    ...
    description2:
      "We have built websites and web applications for clients in many different industries. We’ve had the opportunity to work with some great clients in Vancouver, The United States of America, South America, Europe and Canada.",
    industries: [
      "Architecture",
      "Business",
      "Law",
  ...
  return (
    <div className={classes.bodyMargin}>
      <Head>
        <title key="title">
          Web Design & Development Agency | RangoJango Vancouver
        </title>
        <meta
          name="description"
          key="description"
        ...
        <meta
          name="keywords"
          content="web design agency vancouver, website design vancouver cheap, web development company vancouver, web design in vancouver, web page design in vancouver, website design vancouver"
        />
        <meta
          property="og:title"
          content="Web Design & Development Agency | RangoJango Vancouver"
          key="og:title"
        />
        <meta
          property="og:url"
