...
exports.sendForm = functions.https.onRequest((request, response) => {
  cors(request, response, () => {
    const { firstName, lastName, email, phone } = request.query;

    //check here if everything is alright, if not, send back a 404 with a message saying the error

    //this will change mailOptions to this so you can send it, you will need to change it again when you send it to the user as well
    mailOptions = {
      from: "RangoJango",
      to: "samuelclintoc99@gmail.com",
                            ...
                            <tr>
                              <td align="center">
                                ...
                                >
                                  <img
                                    align="center"
                                    src="https://i.imgur.com/w4mXfMa.png"
                                    alt="Rango Jango"
                                    width="600"
                                    height=""
                                    style="
                                    ...
                                    <td align="center" style="padding: 40px 10px">
                                      ...
                                      >
                                        ...
                                        <tr>
                                          ...
                                          >
                                            <a
                                              href="mailto:info@rangojango.com"
                                              style="
                                                color: #ffffff;
                                                text-decoration: none !important;
                                              "
                                              >info@rangojango.com</a
                                            >
                                          </td>
                                        </tr>
                                      </table>
